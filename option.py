...
### model setting
parser.add_argument('--num_res_blocks', type=str, default='4+4+2+1',
...
parser.add_argument('--tpl_use_S', type=str2bool, default=True,
...
parser.add_argument('--ref_w', type=float, default=0,
                    help='The weight of ReconstructRef loss')
...
parser.add_argument('--ref_rate', type=float, default=1e-4,
                    help='Learning rate for the recover ref net.')
...
parser.add_argument('--test', type=str2bool, default=False,
                    help='Test mode')
parser.add_argument('--test_gt', type=str2bool, default=False,
                    help='Test with GT or not')
parser.add_argument('--num_MSFP', type=int, default=3,
                    help='--Number of MSFP blocks.')
